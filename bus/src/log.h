...
typedef struct hw_log_ops {
    void (*log)(int level, const char *plugin_id, const char *fmt, va_list ap);
...
extern void hw_log_vwrite(hw_log_ctx_t *ctx, int level, const char *plugin_id, const char *fmt,
                          va_list ap);
extern void hw_log_write(hw_log_ctx_t *ctx, int level, const char *plugin_id, const char *fmt, ...)
#ifdef __GNUC__
